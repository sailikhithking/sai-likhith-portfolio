            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="grid gap-4">
                  {socialLinks.map(social => <Card key={social.name} className="bg-white/5 backdrop-blur-sm border-white/10 hover:bg-white/10 transition-all duration-300">
            ...
            <div>
                  ...
                  <form className="space-y-6">
                    <div className="grid md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input type="text" className="bg-white/5 border-white/10 text-white placeholder-gray-400 focus:border-cyber-blue focus:ring-cyber-blue/20" placeholder="Your first name" />
                      </div>
                      <div>
                        <Label className="text-gray-300 mb-2 block">
                          Last Name  
                        </Label>
                        <Input type="text" className="bg-white/5 border-white/10 text-white placeholder-gray-400 focus:border-cyber-blue focus:ring-cyber-blue/20" placeholder="Your last name" />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <Input type="email" className="bg-white/5 border-white/10 text-white placeholder-gray-400 focus:border-cyber-blue focus:ring-cyber-blue/20" placeholder="your.email@example.com" />
                    </div>
                    ...
                    <div>
                      ...
                      <Input type="text" className="bg-white/5 border-white/10 text-white placeholder-gray-400 focus:border-cyber-blue focus:ring-cyber-blue/20" placeholder="What's this about?" />
                    </div>
                    ...
                    <div>
                      ...
                      <Textarea rows={5} className="bg-white/5 border-white/10 text-white placeholder-gray-400 focus:border-cyber-blue focus:ring-cyber-blue/20 resize-none" placeholder="Tell me about your project or just say hello!" />
                    </div>
                    
                    <Button type="submit" className="w-full bg-gradient-to-r from-cyber-blue to-cyber-green hover:from-cyber-green hover:to-cyber-blue text-black font-semibold py-3 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-cyber-blue/50">
              ...
              <div className="mt-6 flex items-center justify-center gap-2 text-gray-400">
                <div className="flex gap-1">
                  ...
                  <div className="w-2 h-2 bg-cyber-green rounded-full animate-bounce" style={{
                  animationDelay: '0.1s'
                }}></div>
                  <div className="w-2 h-2 bg-cyber-purple rounded-full animate-bounce" style={{
                  animationDelay: '0.2s'
                }}></div>
                </div>
